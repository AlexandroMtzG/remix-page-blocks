...
export default function PageBlockEditMode({ items, onSetBlocks }: { items: PageBlockDto[]; onSetBlocks: (items: PageBlockDto[]) => void }) {
  ...
  return (
    <div>
      <div className="border-b border-gray-700 bg-gray-900 p-2 text-gray-50 dark:bg-gray-50 dark:text-gray-900">
        <div className="flex justify-center space-x-3">
          ...
          <ButtonSecondary onClick={toggleEditMode}>
            {isEditMode() ? (
              ...
              <div>
                <span className="hidden sm:block">Edit Mode</span>
          ...
          <ButtonSecondary to="https://saasrock.com/?ref=remix-page-blocks" target="_blank">
            <div>Built by SaasRock</div>
          </ButtonSecondary>
        </div>
      </div>
